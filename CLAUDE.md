...
>
> Este repo é o **Antessala** — triagem pré-anestésica offline. Ele nasceu como fork do
> FlowKit e **o resto deste arquivo ainda descreve o FlowKit original**, incluindo peças
> que serão removidas (STT, llama.cpp, MCP, galeria, importers, busca semântica, cron).
> Use-o como mapa do terreno herdado, **não** como especificação do produto.
>
> Fonte canônica do produto, nesta ordem:
>
> 1. `specs/000-produto-antessala/analysis.md` — o que o produto é, as 4 telas, a jornada
...
>
> Leis do produto: o paciente **não é cadastrado** (id descartável, sem deduplicação);
> **não existe evolução** em anamnese; o sistema **não decide** a especialidade de destino.
> Este arquivo será reescrito ao final da spec 001.

---

## Terreno herdado (FlowKit)
