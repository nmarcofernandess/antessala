...
1. **Tabelas** para registro (pessoa embutida, anamnese em JSONB, jornada append-only com
   carimbo de horário) e para os catálogos clínicos. Os estados da jornada estão no
   analyst; o motor que os ordena é do outro Codex — **crie a tabela e o tipo, não a
   ordenação**.
