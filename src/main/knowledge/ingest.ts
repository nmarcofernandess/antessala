...
import type { ImportResult, UnifiedConversation } from '../../shared/importer-types'
...
export async function ingestFromFile(
  ...
  return ingestImportedFileResult(filePath, result, titulo, metadata)
}

export async function ingestImportedFileResult(
  filePath: string,
  result: ImportResult,
  titulo?: string,
  metadata: Record<string, unknown> = {},
