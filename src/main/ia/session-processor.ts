...
export async function extractMemories(
  ...
  try {
    const { object } = await generateObject({
      ...
      prompt: `Analise esta conversa e extraia FATOS CONCRETOS relevantes para conversas futuras.
Foque em: decisoes tomadas, preferencias do usuario, informacoes importantes, correcoes de dados.
NAO extraia: saudacoes, perguntas genericas, dados que ja estao no banco.
