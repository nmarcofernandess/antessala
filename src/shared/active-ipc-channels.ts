export const ACTIVE_IPC_CHANNELS = [
  ...
  'mvp.pendencies.open',
  'mvp.pendencies.list',
  'mvp.pendencies.submitEvidence',
  'mvp.pendencies.acceptEvidence',
  'mvp.returns.book',
  'mvp.results.current',
  ...
  'mvp.ai.proposeFields',
  'mvp.ai.reviewProposal',
  'mvp.knowledge.suggest',
  'mvp.knowledge.approve',
  'mvp.knowledge.search',
  'mvp.users.list',
