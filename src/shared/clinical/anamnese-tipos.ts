/**
 * Modelo de resposta dos widgets pré-anestésicos.
 *
 * Mora em `shared` porque o processo principal calcula o requisito de agenda a
 * partir destas respostas: o renderer coleta, o main decide. Nada aqui importa
 * React ou toca a tela.
 *
